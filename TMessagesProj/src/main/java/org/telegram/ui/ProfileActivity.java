...
public class ProfileActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate, DialogsActivity.DialogsActivityDelegate, PhotoViewer.PhotoViewerProvider {
    ...
    private int pravzhizn_professionRow;
    private int pravzhizn_BirthdayDateRow;
    private int pravzhizn_SaintRow;
    ...
    private ProfileObject pravzhiznProfile;
    private PravzhiznService mService = PravzhiznService.instance.create(PravzhiznService.class);
    ...
    public boolean onFragmentCreate() {
        ...
        if (user_id != 0) {
            ...
            mService.getProfileOfUser(user_id).enqueue(new Callback<ProfileResponse>() {
                @Override
                public void onResponse(final Call<ProfileResponse> call, final Response<ProfileResponse> response) {
                    if (response.body().success) {
                        pravzhiznProfile = response.body().data;
                        if (listAdapter != null) {
    ...
    private void updateRowsIds() {
        ...
        usernameRow = -1;
        pravzhizn_professionRow = -1;
        pravzhizn_BirthdayDateRow = -1;
        pravzhizn_SaintRow = -1;
        settingsTimerRow = -1;
        settingsKeyRow = -1;
        ...
        if (user_id != 0) {
            ...
            if (pravzhiznProfile != null) {
                if (!TextUtils.isEmpty(pravzhiznProfile.profession)) {
                    pravzhizn_professionRow = rowCount++;
                }

                if (!TextUtils.isEmpty(pravzhiznProfile.birthday)) {
                    pravzhizn_BirthdayDateRow = rowCount++;
                }

                if (pravzhiznProfile.saint != null) {
                    pravzhizn_SaintRow = rowCount++;
                }
            }
    ...
    private class ListAdapter extends RecyclerListView.Adapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int i) {
            ...
            switch (holder.getItemViewType()) {
                ...
                case 2:
                    ...
                    } else if (i == pravzhizn_professionRow) {
                        textDetailCell.setTextAndValue(pravzhiznProfile.profession, LocaleController.getString("pravzhizn_profession", R.string.pravzhizn_profession));
                    } else if (i == pravzhizn_BirthdayDateRow) {
                        textDetailCell.setTextAndValue(pravzhiznProfile.birthday, LocaleController.getString("pravzhizn_birthday_date", R.string.pravzhizn_birthday_date));
                    } else  if (i == pravzhizn_SaintRow) {
                        textDetailCell.setTextAndValue(pravzhiznProfile.saint.name, LocaleController.getString("pravzhizn_personal_saint", R.string.pravzhizn_personal_saint));
            ...
            if (checkBackground) {
                ...
                if (user_id != 0) {
                    enabled = i == phoneRow || i == settingsTimerRow || i == settingsKeyRow || i == settingsNotificationsRow ||
                            i == sharedMediaRow || i == startSecretChatRow || i == usernameRow || i == pravzhizn_professionRow || i == pravzhizn_BirthdayDateRow || i == pravzhizn_SaintRow || i == userInfoRow;
                } else if (chat_id != 0) {
        ...
        public int getItemViewType(int i) {
            if (i == emptyRow || i == emptyRowChat || i == emptyRowChat2) {
                ...
                return 1;
            } else if (i == phoneRow || i == usernameRow || i == pravzhizn_professionRow || i == pravzhizn_BirthdayDateRow || i == pravzhizn_SaintRow || i == channelNameRow) {
                return 2;
