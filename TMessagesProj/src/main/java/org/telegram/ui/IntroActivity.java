...
public class IntroActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (LocaleController.isRTL) {
            icons = new int[]{
                    R.drawable.pravzhizn_intro7,
                    R.drawable.pravzhizn_intro6,
                    R.drawable.pravzhizn_intro5,
                    R.drawable.pravzhizn_intro4,
                    R.drawable.pravzhizn_intro3,
                    R.drawable.pravzhizn_intro2,
                    R.drawable.pravzhizn_intro1
            };
            titles = new int[]{
                    R.string.pravzhizn_Page7Title,
                    R.string.pravzhizn_Page6Title,
                    R.string.pravzhizn_Page5Title,
                    R.string.pravzhizn_Page4Title,
                    R.string.pravzhizn_Page3Title,
                    R.string.pravzhizn_Page2Title,
                    R.string.pravzhizn_Page1Title
            };
            messages = new int[]{
                    R.string.pravzhizn_Page7Message,
                    R.string.pravzhizn_Page6Message,
                    R.string.pravzhizn_Page5Message,
                    R.string.pravzhizn_Page4Message,
                    R.string.pravzhizn_Page3Message,
                    R.string.pravzhizn_Page2Message,
                    R.string.pravzhizn_Page1Message
            };
        } else {
            icons = new int[]{
                    R.drawable.pravzhizn_intro1,
