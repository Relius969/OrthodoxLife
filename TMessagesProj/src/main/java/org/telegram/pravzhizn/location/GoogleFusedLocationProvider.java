...
class GoogleFusedLocationProvider extends BaseLocationProvider
    ...
    GoogleFusedLocationProvider() {
        mGoogleApiClient = new GoogleApiClient.Builder(ApplicationLoader.applicationContext)
...
//                                                                          : LocationRequest.PRIORITY_BALANCED_POWER_ACCURACY);
        ...
        mLocationRequest.setFastestInterval(interval / 2 * 4);
    ...
    private static void resolveError(Status status) {
        ...
        Activity activity = LaunchActivity.sActivity;
        if (activity != null) {
            try {
