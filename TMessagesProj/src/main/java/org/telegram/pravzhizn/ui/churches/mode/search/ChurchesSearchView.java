 ...
 */
public class ChurchesSearchView {
    ...
    private final ChurchesSearchPresenter mPresenter;

    public ChurchesSearchView(final Context context, final ChurchesSearchPresenter presenter) {
        ...
        addListView(context, contentLayout);
