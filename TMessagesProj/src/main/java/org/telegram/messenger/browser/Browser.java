...
public class Browser {
    ...
    public static boolean isInternalUri(Uri uri) {
        ...
        final boolean isTelegramInternal = "tg".equals(uri.getScheme()) || "telegram.me".equals(host) || "telegram.dog".equals(host);
        final boolean isPravzhiznInternal = "pravzhizn".equals(uri.getScheme()) || "pravzhizn.ru".equals(host);
        return isTelegramInternal || isPravzhiznInternal;
    }
}
