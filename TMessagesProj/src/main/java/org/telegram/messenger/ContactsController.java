...
//        return inviteText != null ? inviteText : LocaleController.getString("pravzhizn_InviteText", R.string.pravzhizn_InviteText);
        return LocaleController.getString("pravzhizn_InviteText", R.string.pravzhizn_InviteText);
    }
    ...
    public void checkAppAccount() {
        ...
        accounts = am.getAccountsByType("org.telegram.messenger.techranch");
    ...
    public void deleteAllAppAccounts() {
        try {
            AccountManager am = AccountManager.get(ApplicationLoader.applicationContext);
            Account[] accounts = am.getAccountsByType("org.telegram.messenger.techranch");
            for (int a = 0; a < accounts.length; a++) {
                am.removeAccount(accounts[a], null, null);
            }
        } catch (Exception e) {
